...
public record StockQuoteView(
        ...
        String valuationDirection,
        String ownershipPercentText,
        String expectedDividendText,
        String expectedDividendPerShareText,
        String dividendPayoutRatioText,
        long remainingMarketBuyQuantity,
        long availableBuyQuantity,
        long availableSellQuantity,
        long maxAffordableBuyQuantity,
        String liquidityText,
        boolean hasQuarterlyReport,
        String financialPeriodText,
        String quarterlyRevenueText,
        String operatingProfitText,
        String netIncomeText,
        String earningsSurpriseText,
        String dividendPerShareText,
        String financialDirection,
        String earningsSurpriseDirection,
        String nextEarningsText,
