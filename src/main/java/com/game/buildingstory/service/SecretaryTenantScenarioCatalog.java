...
final class SecretaryTenantScenarioCatalog {
    ...
    private static final List<SecretaryTenantScenario> SCENARIOS = List.of(
            ...
            new SecretaryTenantScenario(
                    ...
                    "대신 갚아주기",
                    300_000_000L, 1_750, null, false, false, 100_000_000, 0,
                    null
            ),
            new SecretaryTenantScenario(
                    "secretary-3", "대전", 2,
                    ...
                    "일 배우게 하기",
                    0L, 4_900, "grandeur", false, false, 0, 30,
                    "건물관리 견습중"
            ),
            new SecretaryTenantScenario(
                    "secretary-4", "부산", 2,
                    ...
                    "위약금 대신 내주기",
                    15_000_000_000L, 11_100, null, false, false, 6_000_000_000L, 0,
                    null
            ),
            new SecretaryTenantScenario(
                    "secretary-5", "인천", 2,
                    ...
                    "사업자금 투자하기",
                    80_000_000_000L, 16_100, null, true, false, 30_000_000_000L, 0,
                    "재무설계 월세 면제"
            ),
            new SecretaryTenantScenario(
                    "secretary-6", "서울", 1,
                    ...
                    "거주환경 마련하기",
                    150_000_000_000L, 0, null, false, true, 0, 0,
                    null
            )
    );
    ...
    static String hireConditionText(SecretarySpec secretary, String fallbackReputationText) {
        return switch (secretary.key()) {
            ...
            case "secretary-2" -> "평판 1750 이상, 현금 3억 이상, 부탁 수락 후 1억원 지급";
            case "secretary-3" -> "평판 4900 이상, 그랜저 보유, 부탁 수락 후 30일 경과";
            case "secretary-4" -> "평판 1만1100 이상, 현금 150억 이상, 부탁 수락 후 60억 지급";
            case "secretary-5" -> "평판 1만6100 이상, 현금 800억 이상, 대출 없음, 부탁 수락 후 300억 지급";
            case "secretary-6" -> "모든 사치품 보유, 현금 1500억 이상, 여의도 대형 오피스복합 구매";
